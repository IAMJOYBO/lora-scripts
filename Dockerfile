...
# 初次安装依赖
RUN pip install -r requirements.txt && pip install --force-reinstall xformers==v0.0.27.post2 torch==2.4.0+cu121 torchvision==0.19 torchaudio==2.4.0+cu121 --index-url https://download.pytorch.org/whl/cu121 && rm -rf ~/.cache/pip/*
